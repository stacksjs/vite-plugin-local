...
Here are all the cool projects that people have built using `vite-plugin-local`.
...
The whole Stacks ecosystem is built using `vite-plugin-local`. Here are some of the projects utilizing it:
